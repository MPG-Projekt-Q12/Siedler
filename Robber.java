    ...
    public void stealRandomResource(Tile tile, Player currentPlayer, Game game) {
        ...
        for (Settlement s : game.getSettlements()) {
            ...
            double dist = Math.hypot(
                    tile.getCenterX() - s.getCenterX(),
                    tile.getCenterY() - s.getCenterY());
        ...
        for (Variables.Resource r : Variables.Resource.values()) {
            ...
            if (r == Variables.Resource.DESERT
            || r == Variables.Resource.DEFAULT)
                continue;
        ...
        Variables.Resource stolen =
            available.get((int)(Math.random() * available.size()));
